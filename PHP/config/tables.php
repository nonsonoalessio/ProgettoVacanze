...
return [
    ...
    'dipendenti' => [
        ...
        'nome' => DB::Varchar() . DB::NotNull(),
        'data_inizio_turno' => DB::Datetime() . DB::NotNull(),
        'cognome' => DB::Varchar() . DB::NotNull(),
        'email' => DB::Varchar(150) . DB::NotNull() . DB::CheckIfIn('@','email'),
        'data_fine_turno' => DB::Datetime() . DB::NotNull(),
    ...
    'prenotazioni' => [
        ...
        'data_inizio_prenotazione' => DB::Datetime() . DB::NotNull(),
        ...
        'data_fine_prenotazione' => DB::Datetime() . DB::NotNull(),
